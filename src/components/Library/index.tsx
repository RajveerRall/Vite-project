        ...
        <div className="relative mb-16">
          ...
          <div className="relative z-20">
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-1.5 text-gray-800">Upload your EPUB or MOBI</h3>
              <p className="text-sm text-gray-500 mb-3">Drag & drop a .epub or .mobi file, or click to choose</p>
              <button className="browse-button" onClick={handleUploadClick}>
                Choose EPUB or MOBI
              </button>
              <input ref={fileInputRef} type="file" accept="application/epub+zip,.epub,application/x-mobipocket-ebook,.mobi" onChange={handleFileChange} className="hidden" />
