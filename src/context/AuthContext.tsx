...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [user, setUser] = useState<User | null>(() => {
    ...
    const signedOut = localStorage.getItem(SIGN_OUT_FLAG_KEY) === 'true';
  ...
  // Initial authentication check is now handled synchronously in useState initializers
  useEffect(() => {
    console.log('[AuthContext] Provider mounted with initialized state');
  }, []);
