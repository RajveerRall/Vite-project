...
Complete guide to the **TTS Usage Tracking System** - how it works, API endpoints, and frontend integration.
...
/api/tts endpoint
    ↓
synthesizeWithMetadata() → Returns audio + metadata
    ↓
usageTracker.trackUsage() → Logs usage data
    ↓
In-Memory Storage (+ optional file persistence)
    ↓
