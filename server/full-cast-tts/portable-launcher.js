...
// IMPORTANT: Set environment variables BEFORE any requires
// This prevents pino-pretty from being loaded in pkg bundles
if (process.pkg) {
  ...
  // Disable pino transport completely to avoid dynamic require issues
  process.env.PINO_LOG_LEVEL = process.env.PINO_LOG_LEVEL || 'info';
}
